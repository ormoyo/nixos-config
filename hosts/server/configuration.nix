...

{
  ...
  boot.initrd.availableKernelModules = [ "hid_generic" "hid_cherry" ];  
...
#    serviceConfig = {
#      ExecStart = "${pkgs.hd-idle}/bin/hd-idle -i 0 -c ata -a /dev/disk/by-uuid/f597bcf2-0d98-456f-9890-4b39f1069c2d -i 900";
#    };
#  };
}
